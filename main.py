...
STAT_MENTOR = {
    ...
    "대응표본 T-검정": {"purpose": "동일 집단의 처치 전후 평균 변화를 비교합니다.", "indicator": "사전-사후 점수 차이가 0에서 얼마나 벗어났는지 검증합니다.", "check": "차이값의 정규성 분포를 검토하십시오."},
    ...
    "신뢰도 분석": {"purpose": "측정 도구의 일관성을 평가합니다.", "indicator": "Cronbach α 계수가 0.7 이상일 때 신뢰도가 확보된 것으로 간주합니다.", "check": "역코딩 문항이 분석 전 적절히 변환되었는지 확인하십시오."},
